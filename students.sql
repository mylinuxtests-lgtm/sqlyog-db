...
/*Table structure for table `vw_estudiantes_detalle` */

DROP TABLE IF EXISTS `vw_estudiantes_detalle`;

/*!50001 DROP VIEW IF EXISTS `vw_estudiantes_detalle` */;
/*!50001 DROP TABLE IF EXISTS `vw_estudiantes_detalle` */;

/*!50001 CREATE TABLE  `vw_estudiantes_detalle`(
 `ID` int(11) ,
 `Nombre` varchar(50) ,
 `Sexo` varchar(20) ,
 `Edad` decimal(10,0) ,
